...
def execute(**kwargs) ->TriggerFlowParams:
    ...
    new_file_param = FileParam(filename, content_type, body, param, '',
        upload_time)
    return TriggerFlowParams(single_file_params={new_file_param.param:
        new_file_param}, multi_file_params=None, benchling_tag=None,
