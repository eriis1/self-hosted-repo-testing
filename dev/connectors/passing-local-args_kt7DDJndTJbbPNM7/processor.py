...
def get_param_mapping(watch_dir: str, parent_dir: str='', file_name: str='',
    modified_time: str='', body: bytes=bytes()) ->Dict[str, Callable[[str],
    bool]]:
    id_group = re.search('^(\\w+)', file_name)
    if id_group == None:
        return {}
    id = id_group.group()
    return {}
