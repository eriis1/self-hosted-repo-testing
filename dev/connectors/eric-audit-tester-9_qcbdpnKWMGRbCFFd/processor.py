...
from agent_sdk import FileParam, FileWatcherResult, NoOpFileTagParams
...
# Required Function
def execute(flow_params_fw: FileWatcherResult, **kwargs) -> NoOpFileTagParams | None:
    file_params: list[FileParam | list[FileParam]] = list(flow_params_fw.files.values())
