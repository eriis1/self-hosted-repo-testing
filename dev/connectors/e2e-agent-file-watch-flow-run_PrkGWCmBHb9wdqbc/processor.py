...
from agent_sdk import FileParam, FileWatcherResult, TriggerFlowParams, add_file_tag_to_fileparam
...
def execute(flow_params_fw: FileWatcherResult, **kwargs) -> TriggerFlowParams | None:
    ...
    for param in flow_params_fw.files.values():
        ...
        add_file_tag_to_fileparam(file_param = param, tag_type_id="data_source_type", display_value="e2e_tag_from_processor")
