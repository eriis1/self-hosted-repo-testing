...
def execute(
    ...
    # This docstring is copypasta, need 2 change
    ...
    -------
    tuple[str, FlowInputs]
        Flow, FlowInputs class for kicking off subsequent Flow
    """
    ...
    files_out = [
        FlowInputFile(
            node_name="CSV_Read",
            param_name="csv",
            files={"demo_file.csv": bytes_file},
        ),
        FlowInputFile(
            node_name="CSV_Read_Multi",
            param_name="csv",
            files={"demo_file1.csv": bytes_file, "demo_file2.csv": bytes_file},
        ),
    ]
