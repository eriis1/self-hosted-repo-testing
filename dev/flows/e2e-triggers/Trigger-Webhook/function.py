...
def execute(
    ...
    """
    webhook_api_key = get_secret("webhook-app")
    data = {"test_field": "valid", "extra_field": "extra", "other": {"nested": "nested_value"}}
    resp = requests.post(
        "https://dev.ganymede.bio/event/ganymede-dev-multi/webhook",
        headers={"x-api-key-webhook-app": webhook_api_key, "Content-Type": "application/json"},
