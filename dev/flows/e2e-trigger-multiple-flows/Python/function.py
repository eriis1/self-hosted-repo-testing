...
def execute(
    ...
    initiator = RunConfInitiator(
                    initiator_type=InitiatorTypes.FLOW, initiator_id='e2e-trigger-multiple-flows'
                )
    run_conf = RunConf(
        run_tag=None,
        display_tag=None,
    ...
    api_requests.trigger_flow_run('e2e-triggered-1', run_conf)
    api_requests.trigger_flow_run('e2e-triggered-1', run_conf)

    api_requests.trigger_flow_run('e2e-triggered-2', run_conf)
    api_requests.trigger_flow_run('e2e-triggered-2', run_conf)
